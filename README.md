...
## Algorithm
Step1. Use the standard libraries in python for finding linear regression.

Step2. Set variables for assigning dataset values.

Step3. Import linear regression from sklearn.

Step4. Predict the values of array.

Step5. Calculate the accuracy, confusion and classification report by importing the required modules from sklearn.
